...
QT_MOC_LITERAL(1, 9, 15), // "signalCheckItem"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 14), // "QGraphicsItem*"
QT_MOC_LITERAL(4, 41, 4), // "item"
QT_MOC_LITERAL(5, 46, 13) // "slotGameTimer"

    },
    "Triangle\0signalCheckItem\0\0QGraphicsItem*\0"
    "item\0slotGameTimer"
};
...
void Triangle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Triangle::*_t)(QGraphicsItem * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Triangle::signalCheckItem)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Triangle::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Triangle.data,
...
void *Triangle::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< Triangle*>(this));
...
// SIGNAL 0
void Triangle::signalCheckItem(QGraphicsItem * _t1)
{
