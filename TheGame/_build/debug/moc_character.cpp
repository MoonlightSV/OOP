...
QT_MOC_LITERAL(1, 10, 15), // "signalCheckItem"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 14), // "QGraphicsItem*"
QT_MOC_LITERAL(4, 42, 4), // "item"
QT_MOC_LITERAL(5, 47, 13) // "slotGameTimer"

    },
    "Character\0signalCheckItem\0\0QGraphicsItem*\0"
    "item\0slotGameTimer"
};
...
void Character::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Character::*_t)(QGraphicsItem * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Character::signalCheckItem)) {
                *result = 0;
                return;
            }
        }
...
void *Character::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsItem"))
        return static_cast< QGraphicsItem*>(const_cast< Character*>(this));
...
// SIGNAL 0
void Character::signalCheckItem(QGraphicsItem * _t1)
{
